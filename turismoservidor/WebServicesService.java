 ...
 * 
 */
@WebServiceClient(name = "WebServicesService", targetNamespace = "http://turismoservidor/", wsdlLocation = "http://localhost:9191/turismo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESSERVICE_QNAME = new QName("http://turismoservidor/", "WebServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9191/turismo?wsdl");
    ...
    public WebServices getWebServicesPort() {
        return super.getPort(new QName("http://turismoservidor/", "WebServicesPort"), WebServices.class);
    }
    ...
    public WebServices getWebServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://turismoservidor/", "WebServicesPort"), WebServices.class, features);
    }
