  ...
  <body>
    ...
    <form class="formulario_centrar main" action="login" ACTION="POST">
      <div class="error">
        ...
        <p>
          Asegurese que la entró correctamente y en el si de que estas seguro de
          que sea correcta, entonces alguien hackeo tu cuenta. En ese caso usa
          el login <code>cedula</code> con contraseña <code>prueba</code>.
        </p>
      </div>
